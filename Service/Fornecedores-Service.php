...
class FornecedoresService
{
    ...
    public function registro()
    {
        ...
        $stmt->bindValue(2, $this->fornecedores->__get('nomeFornecedor'));
        $stmt->bindValue(3, $this->fornecedores->__get('CNPJ'));
        $stmt->bindValue(4, $this->fornecedores->__get('fax'));
        $stmt->bindValue(5, $this->fornecedores->__get('telefoneFixo'));
        $stmt->bindValue(6, $this->fornecedores->__get('telefoneCelular'));
        $stmt->bindValue(7, $this->fornecedores->__get('site'));
        $stmt->bindValue(8, $this->fornecedores->__get('logradouro'));
        $stmt->bindValue(9, $this->fornecedores->__get('numero'));
        $stmt->bindValue(10, $this->fornecedores->__get('complemento'));
        $stmt->bindValue(11, $this->fornecedores->__get('bairro'));
        $stmt->bindValue(12, $this->fornecedores->__get('cidade'));
        $stmt->bindValue(13, $this->fornecedores->__get('estado'));
        $stmt->bindValue(14, $this->fornecedores->__get('CEP'));
        $stmt->execute();
