...
//dados da sessao
$nome   = $_SESSION['cliente']['nomeCliente'];
$email  = $_SESSION['cliente']['email'];
$codigo = $_SESSION['cliente']['codigoCliente'];
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
        <span class="navbar-brand">Dashboard do Cliente</span>
        <div>
...
<div class="container mt-4">
    ...
    <div class="card shadow">
        <div class="card-body">
            ...
            <p class="text-muted">Aqui você poderá ver pedidos, atualizar dados, etc.</p>
